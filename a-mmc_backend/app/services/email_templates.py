...
def _base(title: str, body_html: str) -> str:
    ...
    return (
        ...
        'This is an automated message from Alagang MMC. '
...
def appointment_confirmation(
    ...
    body = (
        ...
        f'<p style="margin-top:24px;">Thank you for choosing Alagang MMC.</p>'
    )
...
def initial_credentials_clinician(
    ...
    """
    subject = "Welcome to Alagang MMC \u2014 Your Account Has Been Created"
    title_str = clinician_title or ""
    login_url = (
...
def initial_credentials_secretary(
    ...
    """
    subject = "Welcome to Alagang MMC \u2014 Your Staff Account Is Ready"
    login_url = (
        f"{system_url.rstrip('/')}/staff/login"
        if system_url else
        "[SYSTEM_URL]/staff/login"
